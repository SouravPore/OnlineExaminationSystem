...
<br/>
	...
	<%
		...
		List<Question> high=(List<Question>)session.getAttribute("high");
		Random r = new Random();
    	int x = r.nextInt(high.size());
		Question obj=high.get(x);
 		high.remove(x);
	...
	<div align="center">
 	 <p class="text-center">
                            <button type="submit" onclick="return checkBoxValidation()" class="btn btn-success btn-sm"><i class="fa fa-paper-plane-o"></i> SUBMIT </button>       <button type="reset" onclick="return checkBoxValidation()" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i> Reset</button>
